...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-anime-bg text-slate-100 flex flex-col selection:bg-violet-600 selection:text-white">
      ...
      {/* 3. Footer */}
      <footer className="relative border-t border-slate-900/80 bg-slate-950/80 backdrop-blur-md mt-16 py-10 px-4 md:px-12 text-center text-xs text-slate-400 font-medium overflow-hidden">
